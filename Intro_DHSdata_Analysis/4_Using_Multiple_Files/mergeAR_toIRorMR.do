...
Purpose: 			merge AR data containing HIV test results to a IR or MR file. 
					Each example is shown seperately. 
Author:				Shireen Assaf
Date last modified: May 27, 2021 by Shireen Assaf 
Note:				The master file is the IR or the MR file (each example shown seperately)
...
*rename mv variables to match the v variables
rename mv* v*
